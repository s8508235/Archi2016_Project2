...
{
    cycle = 0;
    iImageData = fopen("open_testcase/pipeline3/iimage.bin","rb");//102062104_01 102062111 102062202_01
    dImageData = fopen("open_testcase/pipeline3/dimage.bin","rb");//102070028_01
    int isize,dsize;
